...
// CreateService ...
func (server *Server) CreateService(servicename, hostname, checkCommand string, checkInterval float64, variables map[string]string) ([]ServiceStruct, error) {

	var newAttrs ServiceAttrs
	newAttrs.CheckCommand = checkCommand
	newAttrs.CheckInterval = checkInterval
